...
// Based on Haxe Serializator by Yaroslav Sivakov (https://bitbucket.org/yar3333/haxe-serializator)
...
class HxSerializator {
	...
	private static function appendCode(f:Function, code:Expr) {
		switch (f.expr.expr) {
			case EBlock(exprs):
	...
	private static function createHxSerializeMethod(fields:Array<Field>, superClass:SuperClass) : Function {
	...
	private static function createHxUnserializeMethod(fields:Array<Field>, superClass:SuperClass) : Function {
		var method : Field = null;
	...
	private static function hasMeta(f:{ meta:Metadata }, m:String) : Bool {
	...
	private static function createMethod(isPublic:Bool, name:String, args:Array<FunctionArg>, ret:Null<ComplexType>, expr:Expr) : Field {
		return {
			  name: name
	...
	private static function getSuperClassField(name:String, superClass:SuperClass) : ClassField {
	...
	private static function getClassMethodArgs(field:ClassField) : Array<FunctionArg> {
		switch (field.type) {
	...
	private static function toFunctionArg(a:{ name:String, opt:Bool, t:Type }) : FunctionArg {
